...
《逐梦少女》是一款快节奏、高难度的2D横板射击游戏，灵感来源于《战火英雄》(Strike Force Heroes)系列。玩家扮演精英战士，在各种战场环境中与敌军作战，通过*精准的射击、灵活的走位和战术决策*生存下来。

### 核心体验

- **紧张刺激**: 快节奏战斗，敌人AI具有威胁性
- **~~技能~~策略驱动**: 玩家~~技术决定成败，而非数值碾压~~采取巧妙的方式提高自身数值，以抵抗敌人的同步成长
- **成长满足**: 角色培养与武器解锁提供长期动力（待加入的少女养成？）
...
| 内容 | 许可证 | 说明 |
|------|--------|------|
| **源代码** | [MIT](LICENSE_CODE) | 自由使用、修改、分发 |
| **艺术资产** | [CC-BY 4.0](LICENSE_ASSETS) | 使用需署名 |

使用本项目资产时，请注明：`"资产来自《逐梦少女》，作者：马戈"`
