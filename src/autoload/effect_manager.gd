...
const EFFECT_PATHS: Dictionary[String, Dictionary] = {
	...
	# 敌人特效
	"enemy_death":
	{"primary": "res://assets/effects/enemy_death.tscn", "placeholder": "", "type": "enemy_death"},
	# 玩家特效
	"player_damage":
	{
	...
	"player_heal":
	{"primary": "res://assets/effects/player_heal.tscn", "placeholder": "", "type": "heal"},
	# 拾取特效
	"pickup_ammo":
	{"primary": "res://assets/effects/pickup_ammo.tscn", "placeholder": "", "type": "pickup"},
	"pickup_health":
	{"primary": "res://assets/effects/pickup_health.tscn", "placeholder": "", "type": "pickup"},
	"pickup_weapon":
	{"primary": "res://assets/effects/pickup_weapon.tscn", "placeholder": "", "type": "pickup"}
}
...
func _cache_effect(effect_name: String) -> bool:
	...
	var scene: PackedScene = ResourceLoaderUtils.load_scene_with_fallback(
		config.primary, config.placeholder
	)
...
# 播放特效（主要接口）
func play_effect(
	effect_name: String, position: Vector2, rotation: float = 0.0, parent: Node = null
) -> Node:
