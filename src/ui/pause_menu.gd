...
func _setup_localized_bindings() -> void:
	...
	_localized_text_binder.bind(
		"pause_label", "CenterContainer/VBoxContainer/PauseLabel", "ui.pause_menu.title"
	)
	_localized_text_binder.bind_node("resume_button", resume_button, "ui.pause_menu.button.resume")
	_localized_text_binder.bind_node(
		"restart_button", restart_button, "ui.pause_menu.button.restart"
	)
	_localized_text_binder.bind_node(
		"settings_button", settings_button, "ui.main_menu.button.settings"
	)
...
func _apply_localized_texts() -> void:
	...
	if confirmation_dialog and confirmation_dialog.visible and not pending_action.is_empty():
		match pending_action:
			"restart":
				confirmation_dialog.dialog_text = LocalizationManager.tr(
					"ui.pause_menu.confirm.restart"
				)
			"menu":
				confirmation_dialog.dialog_text = LocalizationManager.tr(
					"ui.pause_menu.confirm.menu"
				)
			"quit":
				confirmation_dialog.dialog_text = LocalizationManager.tr(
					"ui.pause_menu.confirm.quit"
				)
